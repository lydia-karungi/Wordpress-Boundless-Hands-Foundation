...
function bound_theme_scripts() {
	wp_enqueue_style( 'bound-styles', get_template_directory_uri() . '/assets/css/styles.css' );
    wp_enqueue_script( 'bound-scripts', get_template_directory_uri() . '/assets/js/scripts.js' );
    wp_enqueue_style( 'bound-boot-styles', get_template_directory_uri() . '/assets/css/bootstrap.min.css' );
	wp_enqueue_script( 'bound-boot-scripts', get_template_directory_uri() . '/assets/js/bootstrap.min.js' );
	wp_enqueue_script( 'bound-scripts', get_template_directory_uri() . '/assets/js/jquery.js' );
}


add_action( 'wp_enqueue_scripts', 'bound_theme_scripts' );
